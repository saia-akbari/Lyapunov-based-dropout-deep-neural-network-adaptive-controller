function [e,ftilde,u_list,vecV_list,x,f_list] = RDNN_func_OG(k,L,s,thresh,r,act,L_in,L_out, L_vec,vecV,step_size,simtime,x,ke,ks,Gamma)
...
for i=1:time_length
    ...
    %DNN
    xda=[xdi];  %Augmented with 1 for Bias
