function [Lambdas,Phi,Phi_prime, Time_DNN, Total_FLOPs] = blockgrads(act,vecV,eta,k,L,L_in,L_out) 
tic
...
if(act=="tanh")
    ...
    Total_FLOPs = Total_FLOPs + L*L_out;
    ...
    for j=flip(1:k-1)
        ...
        phi_j=phi_list(:,j);
        Total_FLOPs = Total_FLOPs + L*L + 2*L_out*L*L;
    ...
    Total_FLOPs = Total_FLOPs + L_in*L;
