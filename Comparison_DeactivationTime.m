...
[e_RDNN1,ftilde_RDNN1,u_list_RDNN1,vecV_list_RDNN1,x_RDNN1,f_list_RDNN1]=...
    RDNN_func(k,L,s,Thresh1,deltat,"tanh",L_in,L_out, L_vec,vecV,step_size,simtime,x,ke,ks,Gamma);
[e_RDNN2,ftilde_RDNN2,u_list_RDNN2,vecV_list_RDNN2,x_RDNN2,f_list_RDNN2]=...
    RDNN_func(k,L,s,Thresh2,deltat,"tanh",L_in,L_out, L_vec,vecV,step_size,simtime,x,ke,ks,Gamma);
...
figure(1)
    ...
    legend('No Dropout Deactivation','Dropout Deactivation','Interpreter','latex','Fontsize',16, 'FontName','Times New Roman','Location','NorthEast','Orientation','Horizontal')
