function [e,ftilde,u_list,vecV_list,x,f_list,F_error_rms] = RDNN_func(k,n,L,s,thresh,r,act,L_in,L_out, L_vec,vecV,step_size,simtime,x,ke,ks,Gamma, X_rand)
...
for i=1:time_length
    ...
    [Lambdas,Phi,Phi_prime]=blockgrads_RDNN(act,R, vecV,xda,k,L,L_in,L_out);
    ...
    F_error_rms(:,i)=RDNN_eval(k,L,L_in,L_out,vecV,X_rand,R,xda);
